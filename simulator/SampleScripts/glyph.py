...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      cavity_ = coprocessor.CreateProducer(datadescription, 'input')

      # create a new 'Glyph'
      glyph1 = Glyph(Input=cavity_,
          GlyphType='Arrow')
      glyph1.Scalars = ['POINTS', 'pressure']
      glyph1.Vectors = ['POINTS', 'velocity']
      glyph1.ScaleMode = 'vector'
      glyph1.ScaleFactor = 0.5181962314162128
      ...
      coprocessor.RegisterWriter(parallelPolyDataWriter1, filename='results/sim_results/glyph_%t.pvtp', freq=1)
